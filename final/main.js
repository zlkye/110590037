...
var myProfileSection = document.getElementById('myProfile-list');
 ...
 * Star/unstar post.
 */
function toggleStar(postRef, uid, postId) {
  postRef.transaction(function(post) {
    if (post) {
      if (uid == "02EhWxUydbYCH7KMqeVdNUmTNyJ3"){
        postRef.remove();
        firebase.database().ref('/user-posts/' + post.uid + '/' + postId).remove();
...
function createPostElement(postId, title, text, author, authorId, authorPic) {
  ...
  if (uid == "02EhWxUydbYCH7KMqeVdNUmTNyJ3"){
    ...
    '<div class="post post-' + postId + ' mdl-cell mdl-cell--12-col ' +
      ...
      '<div class="mdl-card mdl-shadow--2dp">' +
        '<div class="mdl-card__title mdl-color--orange-A100 mdl-color-text--white">' +
        ...
        '</div>' +
        '<span class="star">' +
          '<div class="not-starred material-icons">remove_circle_outline</div>' +
          '<div class="starred material-icons">remove_circle_outline</div>' +
        '</span>' +
        '<div class="text"></div>' +
    ...
    var html =
        '<div class="post post-' + postId + ' mdl-cell mdl-cell--12-col ' +
          ...
          '<div class="mdl-card mdl-shadow--2dp">' +
            ...
            '</div>' +
            '<span class="star">' +
              '<div class="not-starred material-icons">favorite_border</div>' +
              '<div class="starred material-icons">favorite</div>' +
  ...
  var onStarClicked = function() {
    ...
    toggleStar(globalPostRef, uid, postId);
    toggleStar(userPostRef, uid, postId);
  };
...
function cleanupUi() {
  ...
  myProfileSection.getElementsByClassName('posts-container')[0].innerHTML = '';
...
function showSection(sectionElement, buttonElement) {
  ...
  myProfileMenuButton.classList.remove('is-active');
